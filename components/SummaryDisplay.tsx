...
const SummaryDisplay: React.FC<SummaryDisplayProps> = ({ matches, allPlayers, onDeletePlayer, onClearAllPlayers, roleFilters, toggleRoleFilter, sortOption, setSortOption, showAdminControls = false, myClientId, onEditPlayer, timezoneFilter = 'all', setTimezoneFilter }) => {
    ...
    <div className="space-y-8">
      ...
      <div>
        <div className="flex justify-between items-center mb-4">
            ...
            <div className="flex items-center gap-2">
              {showAdminControls && (
                <button onClick={onClearAllPlayers} className="text-sm bg-red-800 hover:bg-red-700 text-red-100 font-semibold py-1 px-3 rounded-md transition-colors">Clear All</button>
              )}
            </div>
        </div>
